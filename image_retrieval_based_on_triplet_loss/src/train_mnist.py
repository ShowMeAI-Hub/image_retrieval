...
t.model.load_weights('model128_bin_batch2.weights.best.mnist.hdf5', by_name=False)
checkpoint = ModelCheckpoint(
        filepath='model128_bin_batch2.weights.best.mnist.hdf5',
